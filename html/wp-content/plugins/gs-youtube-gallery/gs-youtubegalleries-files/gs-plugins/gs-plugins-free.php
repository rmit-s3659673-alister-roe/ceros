...
if( ! class_exists( 'GS_Plugins_free' ) ){
    
    class GS_Plugins_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GS_Plugins_free ) {
                self::$_instance = new GS_Plugins_free();
            }
        ...
        public function gs_plugins_free_menu() {
            ...
            add_submenu_page( 
                ...
                'manage_options', 
                'gs-plugins-free', 
                array( $this, 'gs_twitter_free_menu_cb' )
                );
        }
        
        public function gs_twitter_free_menu_cb() { ?>	  
    ...
    $gsplugin_free = GS_Plugins_free::get_instance();
}