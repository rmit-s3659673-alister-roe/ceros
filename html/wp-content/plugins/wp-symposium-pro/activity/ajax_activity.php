...
//                                          if ($report) $settings .= '<a class="wps_activity_settings_report" rel="'.$item->ID.'" href="mailto:'.$report_email.'?subject='.wps_curPageURL().wps_query_mark(wps_curPageURL()).'view='.$item->ID.'">'.$report_label.'</a>'; //TWC replaced with two lines below as per Simon
                                            $profile_url = get_page_link(get_option('wpspro_profile_page')); //TWC - Added as per Simon
                                            if ($report) $settings .= '<a class="wps_activity_settings_report" rel="'.$item->ID.'" href="mailto:'.$report_email.'?subject='.$profile_url.wps_query_mark($profile_url).'view='.$item->ID.'">'.$report_label.'</a>'; //TWC - Changed as per Simon
