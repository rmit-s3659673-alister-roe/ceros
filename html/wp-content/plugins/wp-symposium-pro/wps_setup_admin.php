                    ...
                    if (isset($_GET['wps_reset_options'])) {
                        ...
                        echo '<div id="wps_admin_getting_started_options_right" style="display: none;">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_user_id_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-user-id/');
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_is_logged_in_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-is-logged-in/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_not_logged_in_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-not-logged-in/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_is_forum_posts_list_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-is-forum-posts-list');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_is_forum_single_post_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-is-forum-single-post');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_activity_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-activity/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_activity_page_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-activity-page');
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_activity_post_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-activity-post/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__("Optional CSS class for button", WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_display_name_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-display-name/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_last_logged_in_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-last-logged-in/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_last_active_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-last-active/');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_alerts_activity_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-alerts-activity');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_avatar_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-avatar');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_avatar_change_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-avatar-change');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_avatar_change_link_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-avatar-change-link');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Style of avatar change', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    ...
                                    echo '<tr id="wps_shortcode_tip" style="display:none"';
                                        echo '><td colspan="3" class="wps_admin_shortcode_tip">'.sprintf(__('See <a href="%s" target="_blank">WPS Pro Codex</a> for styling tips.', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/wps-forum/').'</td></tr>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_backto_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-backto');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_comment_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-reply');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_page_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-page');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Style', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_post_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-post');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forums_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forums');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_show_posts_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-show-posts');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_children_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-children');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Show Header', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_forum_sharethis_insert_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-forum-sharethis');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('No options', WPS2_TEXT_DOMAIN).'</td></tr>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_friends_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-friends');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_friends_status_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-friends-status');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_friends_pending_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-friends-pending');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_friends_add_button_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-friends-add-button');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_friends_count_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-friends-count');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('User', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_alerts_friends_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-alerts-friends');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__("Icon size", WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_favourite_friend_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-favourite-friend');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Style', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_usermeta_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-usermeta');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_usermeta_button_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-usermeta-button');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_usermeta_change_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-usermeta-change');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__("Label for update button", WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_usermeta_change_link_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-usermeta-change-link');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Text for the link', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_close_account_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-close-account');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Optional CSS class for button', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_join_site_tab');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-join-site');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                                    echo '<tr><td>'.__('Optional CSS class for button', WPS2_TEXT_DOMAIN).'</td><td>';
                            ...
                            echo wps_show_options($wps_expand_shortcode, 'wps_no_user_check');
                                ...
                                echo wps_codex_link('http://www.wpsymposiumpro.info/wps-no-user-check');
                                echo '<p><strong>'.__('Options', WPS2_TEXT_DOMAIN).'</strong><br />';
                                echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
...
if (!function_exists('wps_admin_getting_started_extensions')):
    ...
    function wps_admin_getting_started_extensions() {
        ...
        <tr class="form-field">
            ...
            <td>
                <?php
                echo '<p><em>'.sprintf(__('There are many <a href="%s">video tutorials</a> available, and a complete Codex covering everything, <a target="_blank" href="%s">The Complete Guide to WP Symposium Pro</a>.', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/tag/video/', 'http://www.wpsymposiumpro.info').'</em></p>';
                ...
                echo wps_show_core($values,     'core-profile',             __('Profile', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/profile-page/', '');
                echo wps_show_core($values,     'core-activity',            __('Activity', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/profile-page/', '');
                echo wps_show_core($values,     'core-avatar',              __('Avatar', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/profile-page/', '');
                echo wps_show_core($values,     'core-friendships',         __('Friendships', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/profile-page/', '');
                echo wps_show_core($values,     'core-alerts',              __('Alerts', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/email-alerts/', '');
                echo wps_show_core($values,     'core-forums',              __('Forums', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-page/', '');
                
                $values = get_option('wps_default_extensions');
                $values = $values ? explode(',', $values) : array();
                echo '<p style="font-size:2.0em;">'.__('System', WPS2_TEXT_DOMAIN).'</p>';
                echo wps_show_extensions($values, 'ext-alerts-customise',   __('Customize Email alerts', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/email-alerts/', '');
                ...
                echo wps_show_extensions($values, 'ext-login',              __('Login/Redirect, add restrict access to WordPress dashboard', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/wps-login-form/', '');
                echo wps_show_extensions($values, 'ext-system-messages',    __('System Messages', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/system-messages/', '');
                ...
                if (strpos(WPS_CORE_PLUGINS, 'core-activity') !== false):
                    echo wps_show_extensions($values, 'ext-activity-whoto',     __('Allow users to choose activity recipient(s)', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/choosing-activity-recipients/', '');
                    echo wps_show_extensions($values, 'ext-crowds',             __('Let users create activity share lists (requires above to be activated)', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/activity-share-lists/', '');
                    echo wps_show_extensions($values, 'ext-attachments',        __('Add images to activity posts', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/activity-attachments/', '');
                    echo wps_show_extensions($values, 'ext-soundcloud',         __('Automatically show Soundcloud on activity', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/activity-attachments/', '');
                    echo wps_show_extensions($values, 'ext-youtube',            __('Automatically show YouTube videos when URL included', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/activity-attachments/', '');
                    echo wps_show_extensions($values, 'ext-remote',             __('Automatically show website link previews', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/activity-attachments/', '');
                    echo wps_show_extensions($values, 'ext-likes',              __('Allow users to like/dislike activity posts and replies', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/likes-and-dislikes/', '');
                    echo wps_show_extensions($values, 'ext-favourites',         __('Let members keep track of favorite activity posts', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/favorite-activity/', '');
                    echo wps_show_extensions($values, 'ext-activity-facebook',  __('Allow sharing of activity posts to Facebook', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/activity-to-facebook/', '');
                else:
                ...
                if (strpos(WPS_CORE_PLUGINS, 'core-profile') !== false):
                    echo wps_show_extensions($values, 'ext-extended',           __('Add custom profile extensions', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/profile-extensions/', 'http://www.wpsymposiumpro.info/user-profile-extensions-videos/');
                    echo wps_show_extensions($values, 'ext-security',           __('Allow members to personalise profile security', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/profile-security/', '');
                    echo wps_show_extensions($values, 'ext-directory',          __('Display a directory of members', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/member-directory/', '');
                    echo wps_show_extensions($values, 'ext-default-friends',    __('Set default friends when a user joins', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/default-friends/', '');
                    echo wps_show_extensions($values, 'ext-rewards',            __('Reward users with points for actions taken', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/user-rewards/', 'http://www.wpsymposiumpro.info/the-rewards-extension-video/');
                    echo wps_show_extensions($values, 'ext-gallery',            __('Allow users to add image galleries', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/image-galleries/', '');
                    echo wps_show_extensions($values, 'ext-tags',               __('Convert user @tags (user logins) in activity/forums. User selector pop-up not compatible with forum WYSIWYG toolbar.', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/user-tags/', '');
                    echo wps_show_extensions($values, 'ext-reviews',            __('Reviews of users.', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/wps-reviews/', '');
                else:
                ...
                if (strpos(WPS_CORE_PLUGINS, 'core-forums') !== false):
                    echo wps_show_extensions($values, 'ext-forum-attachments',  __('Allow image and document attachments', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/image-and-document-attachments-forum/', '');
                    echo wps_show_extensions($values, 'ext-forum-extended',     __('Set custom fields for new forum posts', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/custom-forum-fields-forum-extensions/', '');
                    echo wps_show_extensions($values, 'ext-forum-reply-extended',   __('Set custom fields for forum replies', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/custom-forum-fields-forum-extensions/', '');
                    echo wps_show_extensions($values, 'ext-forum-search',       __('Add a forum search', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-search/', '');
                    echo wps_show_extensions($values, 'ext-forum-security',     __('Fine tune access and permissions for forums', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-security/', '');
                    echo wps_show_extensions($values, 'ext-forum-signature',    __('Let members add a personalised forum signature (via Edit Profile)', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-user-signatures/', '');
                    echo wps_show_extensions($values, 'ext-forum-subs',         __('Email subscriptions for forum posts and replies', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-subscriptions/', '');
                    echo wps_show_extensions($values, 'ext-forum-to-activity',  __('Send forum posts and replies to profile activity', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-posts-replies-to-activity-stream/', '');
                    echo wps_show_extensions($values, 'ext-forum-toolbar',      __('Add a WYSIWYG toolbar to the forum editor', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-toolbar/', '');
                    echo wps_show_extensions($values, 'ext-forum-youtube',      __('Automatically show YouTube videos when URL included', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-youtube-videos/', '');
                    echo wps_show_extensions($values, 'ext-forum-likes',        __('Allow users to like/dislike forum replies', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-likesdislikes/', '');
                    echo wps_show_extensions($values, 'ext-forum-answer',       __('Allow users to mark a forum reply as an answer', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/forum-answers/', '');
                else:
                ...
                if (strpos(WPS_CORE_PLUGINS, 'core-profile') !== false):
                    echo wps_show_extensions($values, 'ext-groups',             __('Allow members to create groups for group activity', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/group-and-groups/', '');
                    echo wps_show_extensions($values, 'ext-default-groups',     __('Set default group membership for new users', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/default-groups/', '');
                else:
                    echo '<p class="wps_warning">'.__('Requires Profile in core features', WPS2_TEXT_DOMAIN).'</div>';
                endif;
                ...
                if (strpos(WPS_CORE_PLUGINS, 'core-profile') !== false):        
                    echo wps_show_extensions($values, 'ext-mail',               __('Private messages between one or more recipients', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/private-messages-mail/', '');
                    echo wps_show_extensions($values, 'ext-mail-attachments',   __('Allow mail attachments', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/private-message-attachments/', '');
                    echo wps_show_extensions($values, 'ext-mail-youtube',       __('Automatically show YouTube videos when URL included', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/private-message-attachments/', '');
                    echo wps_show_extensions($values, 'ext-mail-subs',          __('Setup email alerts for new mail and replies', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/private-message-email-alerts/', '');
                    echo wps_show_extensions($values, 'ext-menu-alerts',        __('Show unread mail count in menu (requires change to menu item, click on help icon!)', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/menu-alerts/', '');
                else:
                    echo '<p class="wps_warning">'.__('Requires Profile in core features', WPS2_TEXT_DOMAIN).'</div>';
                endif;
                ...
                echo wps_show_extensions($values, 'ext-calendar',           __('Display calendars on your site', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/calendar-for-site/', '');
                echo wps_show_extensions($values, 'ext-show-posts',         __('Show blog posts, activity, mail, forum activity - amazingly powerful!', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/wps-show-posts/', '');
                echo wps_show_extensions($values, 'ext-migrate',            __('WP Symposium forum migration tool', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/migrating-from-wp-symposium-to-wp-symposium-pro/', '');
                echo wps_show_extensions($values, 'ext-migrate-bbpress',    __('BBpress forum migration tool', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info/migrating-from-bbpress-to-wp-symposium-pro/', '');
                ?>
            </td>
        </tr> 
        </table>
