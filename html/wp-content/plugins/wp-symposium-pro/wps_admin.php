...
<h1>Get WP Symposium Pro Extensions Plugin for a crazy price!</h1>
...
<p><strong>Get WP Symposium Extensions -for the crazy price!</strong> <a href="https://www.wpsymposiumpro.com">Get it now!</a></p>

<p>All that good stuff, that's not available in the core!</p>

<h2>We are offering the Forever Licence, for the crazy price!</h2>
...
function wpspro_release_notes() {
  	...
  	echo '<div class="wrap">';
	  	...
	  	echo '<div id="wps_release_notes">';
            ...
            <em><strong>Robert, WP Symposium developer (and tea drinker, drink tea, tea is good)</strong></em></p>
  	...
  	echo '<div class="wrap">';
		...
		echo '<div '.$show_header.'id="wps_welcome">';
			...
			echo '<div style="width:30%; min-width:200px; margin-right:10px; float: left;">';
				...
				echo '<p style="font-weight:100;">'.sprintf(__('We also have an <a target="_blank" href="%s">online admin guide</a> and <a target="_blank" href="%s">video tutorials</a>...', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.info', 'http://www.wpsymposiumpro.info/tag/video').'</p>';
			echo '</div>';
