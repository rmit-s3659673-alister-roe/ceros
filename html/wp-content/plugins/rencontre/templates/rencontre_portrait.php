...
<?php if(($u->ID)==29) {
 echo do_shortcode( '[instagram-feed user="s_sideek"]' );
 echo do_shortcode( '[youtube-feed channel="UCVAWjQF3dCQBg8F3kdbiZaA"]' );
 echo do_shortcode( '[wpgmza id="1"]' ); }
?>

<?php if(($u->ID)==16) {
 echo do_shortcode( '[instagram-feed user="alistercaviar"]' );
